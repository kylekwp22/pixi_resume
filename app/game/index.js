...
app.ticker.add(delta => {
  ...
  Listener.on("W", () => {
    const currentPlayerStats = getCurrentPlayerSprite(rocketStats.id);
    rocketStats.y -= 4;
    currentPlayerStats.setTexture( PIXI.Texture.fromImage("static/images/up.png")); 
    sendData();
  });
  ...
  Listener.on("S", () => {
    const currentPlayerStats = getCurrentPlayerSprite(rocketStats.id);
    rocketStats.y += 4;
    currentPlayerStats.setTexture( PIXI.Texture.fromImage("static/images/down.png"));
    sendData();
  });
  ...
  Listener.on("A", () => {
    const currentPlayerStats = getCurrentPlayerSprite(rocketStats.id);
    rocketStats.x -= 4;
    currentPlayerStats.setTexture(PIXI.Texture.fromImage("static/images/left.png"));
    sendData();
  });
  ...
  Listener.on("D", () => {
    const currentPlayerStats = getCurrentPlayerSprite(rocketStats.id);
    rocketStats.x += 4;
    currentPlayerStats.setTexture(PIXI.Texture.fromImage("static/images/right.png"));
    sendData();
  });
});
